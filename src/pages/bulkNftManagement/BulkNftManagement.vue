<template>
  <section id="bulkNftManagement" class="divcol gap2">
    ...
    <section v-show="dataControls[dataControls.findIndex(e=>e.key=='nfts')].active" id="container-nfts" class="card divcol gap2">
      <div class="grid" style="--gtc: repeat(auto-fit,minmax(min(100%,var(--size)),1fr));gap:3.5em">
        <v-card v-for="(item,i) in dataNfts" :key="i" color="transparent" @click="selected(item)" class="divcol" :class="{active: item.selected}">
          <img :src="item.img || image" alt="nft images" style="--w:100%; --of: cover;"  class="pointer">
          ...
          <v-card v-for="(item,i) in dataBulk.unlisted" :key="i" class="card">
            <v-sheet color="transparent" class="fwrap acenter gap1" style="--fb: 1 1 12.5em" :class="{active: item.show}">
              <div class="nfts" :title="item.name" :class="{active: false}">
                <img :src="item.img || image" alt="nft images" class="aspect" style="--w:100%;">
              </div>
              <v-sheet class="card">
            ...
            <v-sheet v-show="item.show" color="transparent" class="grid" style="--gtc: repeat(auto-fit, minmax(min(100%,var(--size)),1fr));gap:2em">
      ...
      <template v-if="dataControlsBulk[dataControlsBulk.findIndex(e=>e.key=='listed')].active">
        <div class="divcol gap1">
          <v-card v-for="(item,i) in dataBulk.listed" :key="i" class="card">
            <v-sheet color="transparent"  class="fwrap acenter gap1" style="--fb: 1 1 12.5em" :class="{active: item.show}">
              <div class="nfts" :title="item.name" :class="{active: false}">
                <img :src="item.img || image" alt="nft images" class="aspect" style="--w:100%; --of: cover">
              </div>
              <v-sheet class="card">
                <div class="acenter" style="gap:.5em">
                  <label class="bold">Nfts</label>
